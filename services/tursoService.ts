...
export const searchSimilarChunks = async (
  ...
  try {
    console.log(`🔍 [TURSO VECTOR SEARCH] Starting search for assistant: ${assistantId}, topK: ${topK}`);
    ...
    console.log(`✅ [TURSO VECTOR SEARCH] Found ${chunks.length} chunks:`, chunks.map(c => ({
      fileName: c.fileName,
